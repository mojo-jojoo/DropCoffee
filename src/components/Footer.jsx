            ...
            <div className='bg-black/40 min-h-[400px]'>
                <div className='max-w-7xl mx-auto grid md:grid-cols-3 pb-20 pt-5'>
                    ...
                    <div className='py-8 px-4'>
                        <a href="#" className='font-semibold tracking-widest text-2xl sm:text-3xl font-cursive'>Drop Coffee</a>
                        <p className='pt-4'>Crafted Coffee, Cozy Vibes, Unforgettable Moments – Your Perfect Espresso Escape</p>
                        <a href="https://github.com/mojo-jojoo" target='_blank' className='inline-block bg-[#3d2517] py-2 px-4 mt-5 text-sm rounded-full'>Visit my Github</a>
                    </div>
                    {/* footer links */}
                    <div className='col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10'>
                        ...
                        <div className='py-8 px-4 col-span-2 sm:col-auto'>
                            ...
                            <div>
                                <p className='mb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem, at!</p>
                                <p>+92 1135467890</p>
                                {/* social links */}
