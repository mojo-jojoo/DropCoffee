    ...
    return (
        <div id='contact' style={bgImage} className='min-h-screen flex items-center justify-center p-6'>
            <motion.div
                ...
                <p className='text-center text-lg text-gray-600 mb-1 font-cursive'>We would love to hear from you! Fill out the form below and we’ll get back to you as soon as possible.</p>
                ...
                <div className='mt-8 text-center'>
                    ...
                    <p className='font-semibold text-black'>(+92) 456-7890</p>
